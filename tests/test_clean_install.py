...
class CleanInstallTests(unittest.TestCase):
    ...
    def test_probe_is_valid_python_and_checks_installed_origins(self) -> None:
        ...
        self.assertIn("installed structural execution status mismatch", PROBE_SOURCE)
        self.assertIn("installed structural execution changed source", PROBE_SOURCE)
        self.assertIn("installed structural execution output mismatch", PROBE_SOURCE)
