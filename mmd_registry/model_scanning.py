...
class PmxHeaderScanResult:
    """Result of scanning the PMX header and complete model information."""
...
def scan_pmx_header(
    ...
    This checkpoint intentionally stops before the vertex section. Later
    structural scanner checkpoints will continue from the returned byte
    position using the same binary-reader contracts.
    """
    ...
    try:
        with path.open("rb") as file:
            ...
            try:
                ...
                # The stream is still open here, so tell() remains valid.
