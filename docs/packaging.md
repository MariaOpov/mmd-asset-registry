...
literal attribute. For the current release, the Git/GitHub label `v0.9.5.2` maps
to the PEP 440 Python distribution version `0.9.5.2`. Runtime imports, installed
